...
String b="texts";
//request.getParameter("lessons");
%>
<body background="../imgs/back1.gif">
	<center>
		<div class="container jumbotron jumbotron-fluid" style="font-family:"Comic Sans MS", cursive, sans-serif;">
			<table class="table">
				<center>
					<div class="page-header panel panel-default" style= margin-top:15px;">
						<h1>Achievements</h1>
					</div>
				</center>
				<thead>
